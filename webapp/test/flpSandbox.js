		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "An Demo App to identify deprecated library usage",
									"targetURL": "#sapbtpdemoprojectdeprecated-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpdemoprojectdeprecated-display": {
								"semanticObject": "sapbtpdemoprojectdeprecated",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.demo.projectdeprecated",
									"url": sap.ui.require.toUrl("sap/btp/demo/projectdeprecated")
								}
							}
						}
					}
